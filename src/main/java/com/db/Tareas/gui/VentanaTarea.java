...
/**
    ...
    private void btnModificaTareaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificaTareaActionPerformed
        ...
        if(row1 != -1){
            descripcion = (String) (jTableToDo.getModel().getValueAt(row1, 1));
            estado = (String) (jTableToDo.getModel().getValueAt(row1, 2));
            new VentanaTareaModificar(this, descripcion, estado).setVisible(true);
            dispose();
        }
        
        if(row2 != -1){
            descripcion = (String) (jTableProgress.getModel().getValueAt(row2, 1));
            estado = (String) (jTableProgress.getModel().getValueAt(row2, 2));
            new VentanaTareaModificar(this, descripcion, estado).setVisible(true);
            dispose();
        }
        
        if(row3 != -1){
            descripcion = (String) (jTableDone.getModel().getValueAt(row3, 1));
            estado = (String) (jTableDone.getModel().getValueAt(row3, 2));
            new VentanaTareaModificar(this, descripcion, estado).setVisible(true);
        }
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try{
            if(row1 != -1){
                descripcionNuevo = (String) (jTableToDo.getModel().getValueAt(row1, 1));
                estadoNuevo = (String) (jTableToDo.getModel().getValueAt(row1, 2));
                ts.modificaTarea(descripcionNuevo, estado[1] , descripcionNuevo, estadoNuevo);
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        String descripcionNuevo, estadoNuevo;
        TareasService ts = new TareasService();
        int row1 = jTableProgress.getSelectedRow();
        try{
            if(row1 != -1){
                descripcionNuevo = (String) (jTableProgress.getModel().getValueAt(row1, 1));
                estadoNuevo = (String) (jTableProgress.getModel().getValueAt(row1, 2));
                ts.modificaTarea(descripcionNuevo, estado[0] , descripcionNuevo, estadoNuevo);
                jTableToDo.setModel(new TareaDataModel(ts.getListaTareasPorEstado(estado[0])));
                jTableProgress.setModel(new TareaDataModel(ts.getListaTareasPorEstado(estado[1])));
            }
        }
    ...
    private void btnInsert2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert2ActionPerformed
        ...
        try{
            if(row1 != -1){
                descripcionNuevo = (String) (jTableProgress.getModel().getValueAt(row1, 1));
                estadoNuevo = (String) (jTableProgress.getModel().getValueAt(row1, 2));
                ts.modificaTarea(descripcionNuevo, estado[2], descripcionNuevo, estadoNuevo);
                jTableProgress.setModel(new TareaDataModel(ts.getListaTareasPorEstado(estado[1])));
    ...
    private void btnBack2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBack2ActionPerformed
        String descripcionNuevo, estadoNuevo;
        TareasService ts = new TareasService();
        int row1 = jTableDone.getSelectedRow();
        try{
            if(row1 != -1){
                descripcionNuevo = (String) (jTableDone.getModel().getValueAt(row1, 1));
                estadoNuevo = (String) (jTableDone.getModel().getValueAt(row1, 2));
                ts.modificaTarea(descripcionNuevo, estado[1], descripcionNuevo, estadoNuevo);
                jTableProgress.setModel(new TareaDataModel(ts.getListaTareasPorEstado(estado[1])));
                jTableDone.setModel(new TareaDataModel(ts.getListaTareasPorEstado(estado[2])));
            }
